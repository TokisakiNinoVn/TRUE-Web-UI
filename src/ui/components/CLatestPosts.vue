<template>
  <div class="p-4">
    <h2 class="text-2xl font-bold mb-4">
      <ion-icon name="pencil-outline"></ion-icon>Mới nhất
    </h2>
    ...
    <div class="flex w-full flex-wrap" v-if="posts.length">
      <div
        v-for="post in posts"
        :key="post._id"
        class="one-item bg-white border border-gray-200 rounded-lg shadow-md mb-6 overflow-hidden max-w-[400px] mr-10 transition-transform transform hover:scale-105 hover:shadow-lg"
      >
