  ...
  <main class="flex h-screen">
    <div class="flex-none w-1/3 p-6 border-r border-gray-300 overflow-y-auto">
      ...
      <ul v-if="isLoggedIn && !isLoading && conversations.length" class="space-y-4">
        <li v-for="conversation in conversations" :key="conversation.conversationId" class="flex items-center border rounded-lg p-4 shadow-lg hover:shadow-xl transition-shadow duration-200 bg-white">
