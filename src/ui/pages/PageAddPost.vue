        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-6">
            ...
            <div class="flex flex-col">
              <label for="title" class="text-lg font-medium text-gray-900"
                >Tiêu đề</label
              >
              <input
                v-model="post.title"
            ...
            <!-- Địa chỉ -->
            <div class="flex flex-col">
              <label for="address" class="text-lg font-medium text-gray-900"
                >Địa chỉ</label
              >
              <input
          ...
          <div class="flex flex-col">
            <!-- Chủ -->
            <div class="flex flex-col">
              <label for="owner" class="text-lg font-medium text-gray-900"
                >Chủ</label
              >
              <input
                v-model="post.owner"
            ...
            <!-- Diện tích -->
            <div class="flex flex-col">
              <label for="acreage" class="text-lg font-medium text-gray-900"
                >Diện tích (m²)</label
              >
              <input
            ...
            <!-- Địa chỉ chi tiết -->
            <div class="flex flex-col">
              <label for="realaddress" class="text-lg font-medium text-gray-900"
            ...
            <!-- Giá -->
            <div class="flex flex-col">
              <label for="price" class="text-lg font-medium text-gray-900"
                >Giá (VND)</label
              >
              <input
          ...
          <label for="files" class="text-lg font-medium text-gray-900"
            >Ảnh hoặc Video</label
          >
          <input
            id="files"
            type="file"
          ...
          <div class="mt-4 grid grid-cols-2 gap-4">
            ...
            >
              ...
              />
              <video
                v-if="preview.type.startsWith('video')"
                :src="preview.url"
                class="w-32 h-32 object-cover rounded"
                controls
              />
...
import AddressSelect from "@/ui/components/CAddressSelect.vue";

import { ref } from "vue";
import { useRouter } from "vue-router";
import { usePostStore } from "@/state/post.state";
import { useFileStore } from "@/state/file.state";
